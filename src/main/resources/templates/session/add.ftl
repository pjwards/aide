...
<@layout.extends name="layouts/default.ftl">
    ...
    <title>${myApp.name} :: Sessions :: Add</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <@spring.message "session.add.header"/>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <#list conference.programDates as date>
                                                                <#list date.programs as program>
                                                                    <#if program.programType == "SESSION">
                                                                        <option value="${program.id}" <#if form.programId?? && form.programId == program.id>selected</#if>>${date.formattedScheduleDay} - ${program.title}</option>
                                                                    </#if>
                                                                </#list>
                                                            </#list>
                                                        </select>
                                    ...
                                    <!-- /.panel group -->
                                    <a class="btn btn-danger" href="/conferences/${conference.id}/admin/sessions"><@spring.message "form.btn.cancel"/></a>
